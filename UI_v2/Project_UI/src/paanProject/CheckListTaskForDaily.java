...
import static project_ui.CheckListTaskForTodo.font;
...
public class CheckListTaskForDaily extends javax.swing.JPanel {
    ...
    private void doneItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_doneItemStateChanged
        ...
        if (done.isSelected()) {
            ...
            DailyForm.getDoneNumL().setText(Integer.toString(MainWindow.getPaanModel().getDailyCheck()));
            DailyForm.getRemainNumL().setText(Integer.toString(MainWindow.getPaanModel().getDailyUncheck()));
            DailyForm.getTotalNumL().setText(Integer.toString(MainWindow.getPaanModel().getDailyTotal()));
        }
        else {
