...
public class MemoForm extends javax.swing.JFrame {
    ...
    public static void clearMemoEventMood() {
        eventModel.clear();
        redB.setSelected(false);
        orangeB.setSelected(false);
        yellowB.setSelected(false);
        purpleB.setSelected(false);
        blueB.setSelected(false);
    }
    ...
    public static void setMemoTodo() {
        ...
        for (TaskList taskL: todoList){
            ...
            if (taskL.getStatus() == true) {tempTask.getDone().isSelected();}
            tempTask.getTaskName().setText(taskL.getDetail());
            todoP.add(tempTask);
        }
    }
    
    public static void setMemoEventMood() {
        ...
        if (tempMood == "angry") {redB.isSelected();}
        else if (tempMood == "normal") {orangeB.isSelected();}
        else if (tempMood == "happy") {yellowB.isSelected();}
        else if (tempMood == "bored") {purpleB.isSelected();}
        else if (tempMood == "sad") {blueB.isSelected();}
    }
    ...
    private void rightBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rightBActionPerformed
        ...
        dateL.setText(objTime.getFormattedDateForMemo());
        MainWindow.getPaanModel().setDate(objTime.getFormattedDateForBackend());
        System.out.println(MainWindow.getPaanModel().getFocusDate());
        clearMemoEventMood();
        MainWindow.getPaanModel().loadEvent();
        MainWindow.getPaanModel().loadMood();
        setMemoEventMood();
...
//        JTextField list = new JTextField();
    ...
    private void backBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBActionPerformed
        ...
        int start = MainWindow.getPaanModel().getTodoList().size();
        int i = 0;
