 ...
 * @author faynch
 */
public class usinTable extends javax.swing.JFrame {
    ...
    public JComboBox<String> getDayC() {
        return dayC;
    }

    public JSpinner getEndThourS() {
        return endThourS;
    }

    public JSpinner getEndTminS() {
        return endTminS;
    }

    public JSpinner getStartThourS() {
        return startThourS;
    }

    public JSpinner getStartTminS() {
        return startTminS;
    }

    public JTextField getSubjectT() {
        return subjectT;
    }
        ...
        // TODO add your handling code here:
            ...
            task = String.format("%-10s %02d:%02d - %02d:%02d  %s", 
                ...
                if (validTask()) {
                    ...
                    usinTable.TTModel.addElement(task);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usinTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void createBounds(int day, Object startHour, Object startmin, Object endHour, Object endmin, String task){
        ...
        System.out.println("create bound");
